...
/* DEFINICIÓN DE ESTRUCTURAS BASE PARA LOS NODOS */
    ...
    /* CHECAR SI EXISTE UN VERTICE EN LA CIRCUNFERENCIA */
                    ...
                    if(ady2->vertice->V != main->vertice->V)
                    {
                        ...
                        while(ady3)
                        {
                            if(ady3->vertice->V == main->vertice->V)
                            {
                                ...
                                //radio será nuestro umbral de criterio para averiguar los puntos que están dentro de la circunferencia :)
                                ...
                                if(distanciacheck(aa, bb, cc, node, R))
                                {
                                    ...
                                    continue;
                                    //testeando recursión :)
                                    //contar_triangulos(grafo_head, &(*head_distancia)); //vuelve a checar entre todo con todos otra vez hasta que todo esté bien :)
                                }
...
{   
    ...
    int op, vertices, ID = 0, T = 0, j = 0, triangle;
    float x,y, c;
    BOOL = FALSE;
    glutInit(&argc, argv);
    do
